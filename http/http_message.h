...
public:
    ...
    const std::string& contentRef() const { return content_; }
...
public:
    ...
    static HttpRequest string_to_request(const std::string_view& request_string);
};
...
public:
    ...
    void string_to_response(const std::string_view& request_string);
};
...
//HttpResponse string_to_response(const std::string_view& request_string);
